                        ...
                        <tr>
                            <td class="body" width="100%" cellpadding="0" cellspacing="0" style="text-align: center; border: hidden !important">
                                <div class="inner-body" style="text-align: center !important; background-color: #32CD32">
                                    <h1 style="color: #fff !important; font-size: 30px !important; text-align: center !important;">Let's connect!</h1>
                                </div>
                            </td>
                        </tr>
                                    ...
                                    <tr>
                                        <td class="content-cell" style="padding: 25px !important">
                                            <div style="text-align: center !important">
                                                <h1 style="color: #000 !important; font-size: 25px !important; font-weight: normal !important; text-align: center !important;"><strong>{{ $name }}</strong> has sent you an invite!</h1>
